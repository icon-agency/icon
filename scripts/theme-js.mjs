 ...
 *
 * Four files stay plain IIFEs: velocity-lean, cursor-tilt and strip-drift
 * (each only defines a shared window.ICON engine; consumers declare the
 * library dependency) and
...
export const BEHAVIOURS = {
  ...
  "cursor-tilt": null,
  "strip-drift": null,
  "clients-marquee": "iconClientsMarquee",
