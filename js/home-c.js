 ...
 *   3g. Clients logo marquee — js/clients-marquee.js since Sep 2026.
...
(function () {
  ...
  // The HOMEPAGE's, only: this bundle rides the hero and the intro, and a
  // page that borrows one of them must not inherit a scroll it never asked
  // for (the About page did, through the clients marquee, Sep 2026).
  var USE_LENIS = !!document.querySelector(".page-home");
  ...
  // ---- 3g. Clients logo marquee — MOVED to js/clients-marquee.js (Sep
  // 2026): the marquee went on the About page and took this whole bundle
  // with it (GSAP, Lenis), and Lenis then scrolled the page behind the
  // team panel. It rides the shared engine, js/strip-drift.js, now.
