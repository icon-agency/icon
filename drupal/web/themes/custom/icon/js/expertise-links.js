/* expertise-links.js — GENERATED by scripts/theme-js.mjs from the repo-root js/expertise-links.js.
 * Do not edit here: edit the source and run `npm run build:theme`.
 * The source IIFE runs once per page inside Drupal.behaviors.iconExpertiseLinks.attach()
 * (once() on <html>), so the behaviour body is byte-identical to the prototype's. */
((Drupal, once) => {
  Drupal.behaviors.iconExpertiseLinks = {
    attach(context) {
      if (!once("expertise-links", "html", context).length) return;
