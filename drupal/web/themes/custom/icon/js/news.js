/* news.js — GENERATED by scripts/theme-js.mjs from the repo-root js/news.js.
 * Do not edit here: edit the source and run `npm run build:theme`.
 * The source IIFE runs once per page inside Drupal.behaviors.iconNews.attach()
 * (once() on <html>), so the behaviour body is byte-identical to the prototype's. */
((Drupal, once) => {
  Drupal.behaviors.iconNews = {
    attach(context) {
      if (!once("news", "html", context).length) return;
