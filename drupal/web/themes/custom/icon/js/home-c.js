/* home-c.js — GENERATED by scripts/theme-js.mjs from the repo-root js/home-c.js.
 * Do not edit here: edit the source and run `npm run build:theme`.
 * The source IIFE runs once per page inside Drupal.behaviors.iconHomeC.attach()
 * (once() on <html>), so the behaviour body is byte-identical to the prototype's. */
((Drupal, once) => {
  Drupal.behaviors.iconHomeC = {
    attach(context) {
      if (!once("home-c", "html", context).length) return;
