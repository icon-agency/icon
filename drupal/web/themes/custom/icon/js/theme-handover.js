/* theme-handover.js — GENERATED by scripts/theme-js.mjs from the repo-root js/theme-handover.js.
 * Do not edit here: edit the source and run `npm run build:theme`.
 * The source IIFE runs once per page inside Drupal.behaviors.iconThemeHandover.attach()
 * (once() on <html>), so the behaviour body is byte-identical to the prototype's. */
((Drupal, once) => {
  Drupal.behaviors.iconThemeHandover = {
    attach(context) {
      if (!once("theme-handover", "html", context).length) return;
