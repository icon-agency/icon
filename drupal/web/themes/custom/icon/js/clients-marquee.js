/* clients-marquee.js — GENERATED by scripts/theme-js.mjs from the repo-root js/clients-marquee.js.
 * Do not edit here: edit the source and run `npm run build:theme`.
 * The source IIFE runs once per page inside Drupal.behaviors.iconClientsMarquee.attach()
 * (once() on <html>), so the behaviour body is byte-identical to the prototype's. */
((Drupal, once) => {
  Drupal.behaviors.iconClientsMarquee = {
    attach(context) {
      if (!once("clients-marquee", "html", context).length) return;
