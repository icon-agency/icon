/* FROZEN COPY — js/hero-loader.js as it stood on 31 Aug 2026 (commit e51d8a3),
 * for experiments/hero-backup.html. Do not edit; do not sync. The point is
 * that it stops moving while the homepage hero is reworked.
 *
 * Copied verbatim rather than trimmed to the hero: every other block in
 * home-c.js is element-guarded and no-ops on a page that does not contain
 * its markup, which is the same property experiments/news.html relies on.
 */
